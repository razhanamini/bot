...
INSERT INTO services (id, name, description, price, duration_days, data_limit_gb, is_active, sort_order) VALUES
(1, 'پلن پایه', ' کاربر نامحدود یک ماهه  25 گیگابایت ', 160000, 30, 25, true, 1),
(2, 'پلن استاندارد', 'کاربر نامحدود یک ماهه 50 گیگابایت ', 210000, 30, 50, true, 2),
(3, 'پلن پریمیوم', 'کاربر نامحدود یک ماهه  100 گیگابایت ', 260000, 30, 100, true, 3),
(4, 'پلن پریمیوم++', ' کاربر نامحدود یک ماهه  200 گیگابایت ', 330000, 30, 200, true, 4),
(1111, 'تست رایگان', 'سرویس تست 1 ساعته  200 مگابایت ', 0, 1, 0.2, true, 0);
